            ...
            $("#b_id").change(function(){
                ...
                success:function(res){
                    ...
                    var table="<table border=1>";
                        table +="<tr><th>Email</th><th>status</th></tr>";
                        $.each(res,function(key,data){
                            table+="<tr>";
                            ...
                            table+="</tr>";
                            table+="<td>";
                            table+="input type='radio' name='status_"+key+"' value='present'/>present";
                             table+="input type='radio' name='status_"+key+"' value='absent'/>Absent";
                             table+="</td>";
                             table+="</tr>";
                        })
                        table+="</table>";
...
<form action="add_attendence"  method="post">
